...
class DebitNote extends Model
{
    ...
    protected $table = 'rg_debit_notes';
    ...
    {
        return $this->hasOne('Rutatiina\FinancialAccounting\Models\Account', 'id', 'debit_financial_account_code');
    }

    public function credit_account()
    {
        return $this->hasOne('Rutatiina\FinancialAccounting\Models\Account', 'id', 'credit_financial_account_code');
    }

    public function items()
    {
        return $this->hasMany('Rutatiina\DebitNote\Models\DebitNoteItem', 'debit_note_id')->orderBy('id', 'asc');
    }

    public function ledgers()
    {
        return $this->hasMany('Rutatiina\DebitNote\Models\DebitNoteLedger', 'debit_note_id')->orderBy('id', 'asc');
    }

    public function comments()
    {
        return $this->hasMany('Rutatiina\DebitNote\Models\DebitNoteComment', 'debit_note_id')->latest();
    }
    ...
    {
        return $this->hasMany('Rutatiina\DebitNote\Models\DebitNoteItemTax', 'debit_note_id', 'id');
    }
