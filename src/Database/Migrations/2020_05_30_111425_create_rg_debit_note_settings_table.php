...
class CreateRgDebitNoteSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_debit_note_settings', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_debit_note_settings');
    }
}
