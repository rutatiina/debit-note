...
class CreateRgDebitNoteLedgersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_debit_note_ledgers', function (Blueprint $table) {
            ...
            $table->string('debit_note_table', 60)->nullable();
