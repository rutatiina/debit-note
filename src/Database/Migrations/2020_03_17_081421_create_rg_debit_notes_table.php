...
class CreateRgDebitNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_debit_notes', function (Blueprint $table) {
            ...
            $table->string('document_name', 50)->default('Debit Note');
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_debit_notes');
    }
}
