...
use Rutatiina\DebitNote\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = DebitNote::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
